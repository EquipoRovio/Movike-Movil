...
class PantallaDeComentarioScreen extends StatelessWidget {
  const PantallaDeComentarioScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      _buildQuisieraQueCambiara(context),
                      SizedBox(height: 4.v)
                    ])))));
  }

  /// Section Widget
  Widget _buildQuisieraQueCambiara(BuildContext context) {
    return Container(
        width: 356.h,
        ...
        child: Column(
            ...
            children: [
              Container(
                  ...
                  child: Text("Quisiera que cambiara de colores",
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
  ...
  /// Navigates to the pantallaDeAgradecimientoScreen when the action is triggered.
  onTapImgSend(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.pantallaDeAgradecimientoScreen);
  }
}
