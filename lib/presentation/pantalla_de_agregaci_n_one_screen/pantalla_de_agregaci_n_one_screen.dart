import '../pantalla_de_agregaci_n_one_screen/widgets/drama_item_widget.dart';
...
class PantallaDeAgregaciNOneScreen extends StatelessWidget {
  const PantallaDeAgregaciNOneScreen({Key? key}) : super(key: key);
  ...
  Widget _buildDrama(BuildContext context) {
    return Wrap(
        runSpacing: 22.v,
        spacing: 22.h,
        children: List<Widget>.generate(14, (index) => DramaItemWidget()));
  }
