import '../pantalla_de_agregaci_n_screen/widgets/dramachipview_item_widget.dart';
...
class PantallaDeAgregaciNScreen extends StatelessWidget {
  const PantallaDeAgregaciNScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildDramaChipView(BuildContext context) {
    return Wrap(
        runSpacing: 22.v,
        spacing: 22.h,
        children:
            List<Widget>.generate(14, (index) => DramachipviewItemWidget()));
  }
